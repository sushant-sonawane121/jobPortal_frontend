...
function JobSeekerDashboard() {
  ...
  const sections = {
    MyApplications: <p>This is the Overview section.</p>,
    Manage: <p>This is the Jobs section.</p>,
    Analysis: <p>This is the Analysis section.</p>,
    ...
    <section className="flex min-h-screen bg-white dark:bg-black text-black dark:text-white relative">
      ...
      >
        ...
        <nav className="p-4 pt-6 space-y-4">
          {["MyApplications", "Manage", "Analysis"].map((section) => (
            <button
              key={section}
              onClick={() => {
